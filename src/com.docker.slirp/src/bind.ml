...
let _request_privileged_port local_ip local_port sock_stream =
...
let bind local_ip local_port stream =
  (* FIXME(djs55): need a Uwt-friendly way to call the vmnet API *)
  Hostnet.Port.bind local_ip local_port stream
